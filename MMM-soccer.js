...
Module.register('MMM-soccer', {
    ...
    getDom() {
        ...
        title.innerHTML = this.competition ? this.competition.name : this.name;
        standings.appendChild(title);

        const subtitle = document.createElement('div');
        subtitle.classList.add('xsmall');
        subtitle.innerHTML = this.season ?
        ...
        if (this.standing) {
            ...
            for (let i = firstTeam; i < lastTeam; i += 1) {
                table.appendChild(this.createDataRow(this.standing[i], i, focusTeamIndex, false));
            }
                ...
                if (this.modals.standings) {
                    ...
                    for (let i = 0; i < this.standing.length; i += 1) {
                        expandedTable.appendChild(
                            this.createDataRow(this.standing[i], i, focusTeamIndex, true)
                        );
                    }
